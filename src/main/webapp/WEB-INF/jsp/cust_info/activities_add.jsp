...
<body>
	<form action="activitiesController/activitiesAddAfter" method="post" id="addatvform">
	...
	<input type="hidden" name="atvId" value="0"/>
	<input type="hidden" name="atvCustId" value="${requestScope.customer.custId }"/>
	<input type="hidden" name="atvCustNo" value="${requestScope.customer.custNo }"/>
	<input type="hidden" name="atvCustName" value="${requestScope.customer.custName }"/>
	
<table class="query_form_table">
	<tr>
		<th>时间</th>
		<td><input name="atvDate" value="${requestScope.time }" id="atv_date"/>
			<span class="red_star" id="atv_datespan">*</span></td>
		<th>地点</th>
		<td>
