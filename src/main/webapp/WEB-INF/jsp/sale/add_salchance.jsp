...
<body>
	...
	<form action="chanceController/addChance" method="post">
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			...
			<tr>
				<th>客户名称</th>
				<td><input type="text" name="chcCustName" id="txt" />
			...
			<tr>
				<th>机会描述</th>
				<td colspan="3"><textarea rows="6" cols="50" name="chcDesc"></textarea>
					<span class="red_star">*</span></td>
			</tr>
			<tr>
				<th>创建人</th>
				<td><input name="chcCreateBy" value="${user.usrName }" readonly size="20" />
		...
		<input type="hidden" name="chcDueTo" value=" "/>
		<input type="hidden" name="chcStatus" value=" "/>
	</form>
</body>
</html>