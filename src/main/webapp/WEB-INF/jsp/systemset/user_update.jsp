...
<body>
   <table width="100%" cellSpacing=0 cellPadding=0 border="0px">
	...
	<form action="userManageController/userUpdateAfter" method="post">
		...
		<table class="query_form_table" cellSpacing=1 cellPadding=1>
			...
			<tr>
				...
				<td><input type="text" name="usrName"
					value="${sessionScope.mgr.usrName }" /><span class="red_star">*</span></td>

			</tr>
			<tr>
				<th>密码</th>
				<td><input type="text" name="usrPassword"
					value="${sessionScope.mgr.usrPassword }"><span class="red_star">*</span></td>
			</tr>
			<tr>
				<th>状态</th>
				<c:if test="${sessionScope.mgr.usrFlag==1 }">
				<td colspan="3"><input name="usrFlag" type="radio"
					value="1" checked="checked" />有效
					 <input name="usrFlag" type="radio" value="0" />无效
				</td>
				</c:if>
				<c:if test="${sessionScope.mgr.usrFlag==0 }">
				<td colspan="3"><input name="usrFlag" type="radio"
					value="1"/>有效
